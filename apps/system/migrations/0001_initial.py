# Generated by Django 2.1.2 on 2018-12-05 06:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, default='image/hh.jpg', null=True, upload_to='image/%Y/%m')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.ManyToManyField(blank=True, null=True, to='system.Menu', verbose_name='URL授权')),
            ],
        ),
        migrations.CreateModel(
            name='Structure',
            fields=[
                ...
                ('type', models.CharField(choices=[('unit', '单位'), ('department', '部门')], default='deparment', max_length=20, verbose_name='类型')),
